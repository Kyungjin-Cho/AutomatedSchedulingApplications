...
public final class ScheduleServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.example.service1.ScheduleRequest,
      grpc.example.service1.ScheduleResponse> getRegisterScheduleMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "registerSchedule",
      requestType = grpc.example.service1.ScheduleRequest.class,
      responseType = grpc.example.service1.ScheduleResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc.example.service1.ScheduleRequest,
      grpc.example.service1.ScheduleResponse> getRegisterScheduleMethod() {
    io.grpc.MethodDescriptor<grpc.example.service1.ScheduleRequest, grpc.example.service1.ScheduleResponse> getRegisterScheduleMethod;
      ...
      synchronized (ScheduleServiceGrpc.class) {
        if ((getRegisterScheduleMethod = ScheduleServiceGrpc.getRegisterScheduleMethod) == null) {
          ScheduleServiceGrpc.getRegisterScheduleMethod = getRegisterScheduleMethod = 
              io.grpc.MethodDescriptor.<grpc.example.service1.ScheduleRequest, grpc.example.service1.ScheduleResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "service1.ScheduleService", "registerSchedule"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.example.service1.ScheduleRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.example.service1.ScheduleResponse.getDefaultInstance()))
  ...
  public static abstract class ScheduleServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void registerSchedule(grpc.example.service1.ScheduleRequest request,
        io.grpc.stub.StreamObserver<grpc.example.service1.ScheduleResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                grpc.example.service1.ScheduleRequest,
                grpc.example.service1.ScheduleResponse>(
  ...
  public static final class ScheduleServiceBlockingStub extends io.grpc.stub.AbstractStub<ScheduleServiceBlockingStub> {
    ...
    /**
     */
    public grpc.example.service1.ScheduleResponse registerSchedule(grpc.example.service1.ScheduleRequest request) {
  ...
  public static final class ScheduleServiceFutureStub extends io.grpc.stub.AbstractStub<ScheduleServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.example.service1.ScheduleResponse> registerSchedule(
        grpc.example.service1.ScheduleRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REGISTER_SCHEDULE:
          serviceImpl.registerSchedule((grpc.example.service1.ScheduleRequest) request,
              (io.grpc.stub.StreamObserver<grpc.example.service1.ScheduleResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ScheduleServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return grpc.example.service1.Service1Impl.getDescriptor();
    }
